...
/// handles needed to stop that thread. Events still reach [`subscribe`] via
/// the process-global `GlobalHotKeyEvent::receiver()`, exactly as on macOS.
///
/// [`subscribe`]: HotkeyListener::subscribe
#[cfg(windows)]
pub struct GlobalHotkeyListener {
